<nav>
        ...
        <li class="<?php if($page=='manage-leave') {echo 'active';} ?>">
            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-list"></i><span>Services</span></a>
    
        <ul class="collapse">
                <li ><a href="#"><i class="fa fa-spinner"></i>Add Services</a></li>
                <li ><a href="#"><i class="fa fa-check"></i> Manage Services</a></li>
            </ul>
    ...
    <li class="<?php if($page=='manage-leave') {echo 'active';} ?>">
            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-book"></i><span>Booking Types</span></a>

        <ul class="collapse">
                <li ><a href="#"><i class="fa fa-spinner"></i>Add Event Types</a></li>
                <li ><a href="#"><i class="fa fa-check"></i> Manage Event Types</a></li>
            </ul>
        
        </li>

        <li class="<?php if($page=='manage-leave') {echo 'active';} ?>">
            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-calendar"></i><span>Manage Booking</span></a>

            <ul class="collapse">
                <li ><a href="#"><i class="fa fa-spinner"></i>Pending</a></li>
                <li ><a href="#"><i class="fa fa-check"></i>Approved</a></li>
                <li ><a href="#"><i class="fa fa-times-circle"></i>Declined</a></li>
                <li ><a href="#"><i class="fa fa-history"></i>Booking History</a></li>
            </ul>
            
        </li>

        <li class="<?php if($page=='leave') {echo 'active';} ?>"><a href="#"><i class="fa fa-book"></i><span>B/W Date Reports</span></a></li>
