                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                           ...
                           <li class="#">
                                <a href="#" aria-expanded="true"><i class="ti-bookmark"></i><span>Apply Booking
                                    </span></a>
                            </li>

                            <li class="#">
                                <a href="#" aria-expanded="true"><i class="ti-server"></i><span>View My Booking History
                                    </span></a>
                            </li>

                            <li class="#">
                                <a href="../chat/index.php" aria-expanded="true"><i class="ti-comments"></i><span>Chat
                                    </span></a>
                            </li>
